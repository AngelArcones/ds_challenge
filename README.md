...
This repository contains the work on different exercises to create a Data Science project on spatial analysis
...
```shell
docker exec -it ds_challenge_notebooks /bin/bash
```
...
``` bash
mamba env create -n ds_challenge -f environment.yml
```

This will create an environment called DS_challenge with a common set of dependencies.
